export const HEROES =
    ...
    },
    {
        ...
        + ' himself. Now, he is a premiere member of both the X-Men and the Avengers.'
    },
    {
        name : 'Hulk',
    ...
    },
    {
        ...
        isAvenger : false,
        description : ' TChalla is a brilliant tactician, strategist, scientist, tracker and a ' +
        'master of all forms of unarmed combat whose unique hybrid fighting style incorporates acrobatics '
        + 'and aspects of animal mimicry. TChalla being a royal descendent of a warrior race '
    ...
    },
    {
        ...
        isAvenger : false,
        description : ' Ms. Marvels current powers include flight, enhanced strength, durability ' +
